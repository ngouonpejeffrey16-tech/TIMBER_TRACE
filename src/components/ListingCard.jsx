...
export function ListingCard({
  image, price, acres, location, title, verified = false,
  ...
  return (
    ...
    >
      <div style={{ position: 'relative', height: 180, background: `var(--stone-200) center/cover url(${image})` }}>
        ...
        <button
          ...
          style={{
            ...
            background: 'rgba(250,248,243,0.92)', display: 'flex', alignItems: 'center',
            justifyContent: 'center', boxShadow: 'var(--shadow-xs)',
          }}
        >
      ...
      <div style={{ padding: 'var(--space-4)' }}>
        ...
        {title && (
          <div style={{ marginTop: 4, fontFamily: 'var(--font-sans)', fontSize: 14, fontWeight: 600, color: 'var(--text-strong)' }}>
            {title}
          </div>
        )}
