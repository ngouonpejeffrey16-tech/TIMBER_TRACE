...
export function Checkbox({ label, checked = false, onChange, disabled = false, id, readOnly = false, style = {} }) {
  ...
  return (
    <label htmlFor={fid} style={{
      ...
      <input
        id={fid} type="checkbox" checked={checked} onChange={readOnly ? undefined : onChange}
