        ...
        <React.Fragment key={s}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <div style={{
              ...
              {i < step ? <Icon.check size={15} stroke="#fff" /> : i + 1}
            </div>
  ...
  return (
    <div
      ...
      style={{
        ...
        padding: tall ? '40px 16px' : '22px 16px', textAlign: 'center',
  ...
  if (done) {
    return (
      <div style={{ background: 'var(--bg-page)', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ maxWidth: 560, padding: '80px 28px', textAlign: 'center' }}>
  ...
  return (
    <div style={{ background: 'var(--bg-page)', minHeight: '100vh' }}>
      <header style={{ position: 'sticky', top: 0, zIndex: 30, background: 'var(--paper)', borderBottom: '1px solid var(--border-subtle)' }}>
        <div style={{ maxWidth: 1240, margin: '0 auto', padding: '12px 28px', display: 'flex', alignItems: 'center' }}>
      ...
      <div style={{ maxWidth: 880, margin: '0 auto', padding: '28px' }}>
        ...
        <p style={{ fontSize: 14, color: 'var(--text-muted)', margin: '0 0 24px' }}>
          Free to list. We charge a flat <b style={{ color: 'var(--clay-600)' }}>5% commission</b> only when your land sells.
        </p>
        <StepRail step={step} />
